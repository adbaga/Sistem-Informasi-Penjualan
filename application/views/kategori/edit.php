                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-body"><div class="card">
                            <form method="POST" action="<?php echo base_url('index.php/kategori/update/'.$get_kategori->id) ?>">
                            <div class="card-header">
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="name">Category</label>
                                    <input type="text" name="name" class="form-control" value="<?= $get_kategori->name ?>" />
                                </div>
                                <div class="form-group">
