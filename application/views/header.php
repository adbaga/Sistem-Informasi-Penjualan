      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('index.php/kategori') ?>"><i class="fa fa-circle-o"></i> List Kategori</a></li>
            <li><a href="<?= base_url('index.php/kategori/create') ?>"><i class="fa fa-circle-o"></i> Add Kategori</a></li>
          </ul>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('index.php/kategori') ?>"><i class="fa fa-circle-o"></i> Pickup Point</a></li>
            <li><a href="<?= base_url('index.php/kategori/create') ?>"><i class="fa fa-circle-o"></i> Pengiriman Cepat</a></li>
            <li><a href="<?= base_url('index.php/kategori/create') ?>"><i class="fa fa-circle-o"></i> Pengiriman Reguler</a></li>
          </ul>
